// Shared Action Items query + categorization logic.
// Used by both the on-demand `remindActionItems` tool and the scheduled
// `syncActionItemReminders` sync, so both surfaces stay in lockstep.
